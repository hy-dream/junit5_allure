...
import JsonUtil.JsonSameUtilWithSkipVerfify;
...
//        List<String> obj2=Arrays.asList("1","3","2");
        ...
        System.out.println(JsonSameUtilWithSkipVerfify.same(str3, str4,""));
